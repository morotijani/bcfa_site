...
?>
    ...
    <main id="content" role="main">
        <div class="container content-space-t-3 content-space-t-lg-5">
            ...
            <div class="row gx-3 gx-lg-4">
                <div class="col-5 align-self-end">
                    <!-- 750x750 -->
                    <img class="img-fluid rounded-2" src="./assets/media/service-1.jpg" alt="Image Description">
                </div>
                <div class="col-7">
                    <div class="ms-lg-4">
                        <img class="img-fluid rounded-2" src="./assets/media/service-2.jpg" alt="Image Description">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container content-space-2 content-space-lg-3">
            ...
            <div class="border-top mx-auto my-5" style="max-width: 25rem;"></div>
            <div class="row justify-content-lg-center">
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="d-flex pe-md-5">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Generate strong leads</h4>
                            <p>Influence decision-makers by learning about the Web 3.0 needs of important government agencies and major corporations, and you may be considered for up-and-coming projects.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="d-flex ps-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Gain project insights</h4>
                            <p>Discover possibilities by getting first-hand information on the deadlines and specifications of active projects across the nation.</p>
                        </div>
                    </div>
                </div>
                <div class="w-100"></div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="d-flex pe-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Increases your competitiveness</h4>
                            <p>Learn about the difficulties that the main public and private groups in Ghana are facing, then consider how you can offer them specialized solutions to help them overcome these difficulties.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
                    <div class="d-flex ps-md-5">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4>Get in front of your target market</h4>
                            <p>Gain access to important digital transformation stakeholders working on current and future projects in Ghana and learn about their intentions to invest in new technologies and identify business possibilities.</p>
                        </div>
                    </div>
                </div> 
            </div>
